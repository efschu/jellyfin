...
{
    /// <summary>
    /// Gets or sets a value indicating whether VS Filter pipeline is enabled.
    /// </summary>
    ...
    /// </summary>
    public string VsFilterPreset { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the custom VapourSynth script.
    /// </summary>
    ...
    /// </summary>
    public string VsUpscaleModel { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the interpolation model.
    /// </summary>
    public string VsInterpolationModel { get; set; } = string.Empty;
    ...
    /// </summary>
    public string VsPixelFormat { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the thread count (0 = auto).
    /// </summary>
